  ...
  def recommend_anime(prompt)
    ...
    response = client.chat(
      parameters: {
          ...
          messages: [
            {role: "system", content: "You are the AnimePanda. Your recommendations based on the user's seen anime data. If the user does not have the seen anime data, recommend anime based on your suggestions. Always respond in JSON format. You will recommend five animes from the following JSON #{animes}. "},
